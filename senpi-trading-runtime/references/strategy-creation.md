...
- **Funding rates on Hyperliquid are published PER-HOUR** (paid hourly at 1/8 of the 8h rate). If a guide says per-8h ×3×365, trust HL's docs, not the guide. Annualize accordingly.
