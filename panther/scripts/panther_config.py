"""PANTHER Strategy — Shared config, MCP helpers, state I/O."""
...
SKILL_DIR = Path(WORKSPACE) / "skills" / "panther-strategy"
CONFIG_PATH = SKILL_DIR / "config" / "panther-config.json"
...
def get_wallet_and_strategy():
    wallet = os.environ.get("PANTHER_WALLET", "")
    strategy_id = os.environ.get("PANTHER_STRATEGY_ID", "")
