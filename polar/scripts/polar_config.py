"""POLAR v2.5 — Shared MCP helper + atomic state I/O + output helpers.

v2.5 producer responsibilities are narrower than v3.x:
...
This module provides:
  - load_config()    — read config/polar-config.json
...
polar-producer.py for the wallet hashing.
"""
...
def log(msg):
    print(f"[POLAR-v2.5] {msg}", file=sys.stderr)
