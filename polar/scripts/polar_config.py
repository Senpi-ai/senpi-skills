"""POLAR Strategy — Shared config, MCP helpers, state I/O.
...
HISTORY_FILE = os.path.join(WORKSPACE, "polar-emerging-history.json")
...
def get_wallet_and_strategy():
    wallet = os.environ.get("POLAR_WALLET", "")
    strategy_id = os.environ.get("POLAR_STRATEGY_ID", "")
...
def log(msg):
    print(f"[POLAR] {msg}", file=sys.stderr)
    sys.stderr.flush()
