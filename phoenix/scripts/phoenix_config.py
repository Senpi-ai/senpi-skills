"""PHOENIX Strategy — Shared config, MCP helpers, state I/O.
...
SKILL_DIR = Path(WORKSPACE) / "skills" / "phoenix-strategy"
CONFIG_PATH = SKILL_DIR / "config" / "phoenix-config.json"
...
def get_wallet_and_strategy():
    wallet = os.environ.get("PHOENIX_WALLET", "")
    strategy_id = os.environ.get("PHOENIX_STRATEGY_ID", "")
