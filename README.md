...
|---|---|---|
| **Analyze** | | |
| [`senpi-portfolio`](senpi-portfolio/) | 1.23.0 | All-wallet portfolio, positions, DSL protection, per-strategy mandate reads |
...
| **Run a strategy** | | |
| [`senpi-strategy-discover`](senpi-strategy-discover/) | 2.29.0 | Conversational picker — rank the catalog against your worldview |
| [`senpi-strategy-author`](senpi-strategy-author/) | 3.8.0 | Build/edit a DSL-protected strategy package, one decision at a time |
| [`senpi-strategy-ops`](senpi-strategy-ops/) | 3.18.0 | Deploy / monitor / close a named strategy (`deploy.py`, `close.py`) |
...
| [`senpi-why`](senpi-why/) | 1.2.0 | "Why Senpi / vs. other tools" — the positioning answer |
