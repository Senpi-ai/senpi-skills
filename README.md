...
| [`senpi-strategy-author`](senpi-strategy-author/) | 3.8.0 | Build/edit a DSL-protected strategy package, one decision at a time |
| [`senpi-strategy-ops`](senpi-strategy-ops/) | 3.19.0 | Deploy / monitor / close a named strategy (`deploy.py`, `close.py`) |
| [`senpi-trade`](senpi-trade/) | 1.4.0 | Direct trade or mirror a specific trader — manual positions + copy trading, one decision at a time |
