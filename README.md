...
Some funds' books also map to a single-strategy archetype below (Spider §4, Camel §7, Octopus §13); the volatility, global-macro, event-driven, tail-risk, risk-parity, equity-long/short, IPO-event, and two-speed-market funds (Caracal, Elephant, **Wolf**, **Rhino**, **Ox**, **Cougar**, **Magpie**, **Lion**) are two-book funds documented in [`producer-patterns.md`](senpi-trading-runtime/references/producer-patterns.md) §17–§25.
