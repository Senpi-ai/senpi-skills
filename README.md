...
| [`senpi-improve-trades`](senpi-improve-trades/) | 1.13.0 | Retrospective review + health checks off the **telemetry event log**: exit quality, missed signals, leaks, crashes, "if I'd held" counterfactual |
