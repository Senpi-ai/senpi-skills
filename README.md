...
| [`senpi-ai-quant`](senpi-ai-quant/) | 1.19.0 | **AI Quant** — "run AI quant on 0x…": paste **any** Hyperliquid address → the desk — 90 days of fills, fees, funding; six 0–100 dimensions, a quant score, leaks priced as charged counterfactuals, protection audit, you vs the proven and hot cohorts, market fit, where your edge is. Public data, read-only; Senpi discovery when a token is present |
