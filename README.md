...
| **Run a strategy** | | |
| [`senpi-strategy-discover`](senpi-strategy-discover/) | 2.38.0 | Conversational picker — rank the catalog against your worldview |
...
| [`senpi-trading-runtime`](senpi-trading-runtime/) | 4.1.6 | The runtime contract reference: `scan(inputs, ctx)`, `runtime.yaml`, DSL |
