...
this whole package fresh cost", which is a different question from "did the wallets this deploy
funded get enough" the moment any sleeve was adopted. `belowMin` answers the second one.
