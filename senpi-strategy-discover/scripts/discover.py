...
# The production catalog (generated by senpi-trading-runtime/scripts/gen_catalog.py). Tests pass an
# explicit --catalog fixture; the default must ALWAYS resolve to the real fleet, never a fixture.
DEFAULT_CATALOG = os.path.join(REPO_ROOT, "strategies", "catalog.json")
