"""Starling's engine IS Phalanx's. scanners/scoring.py is byte-identical to
...
DST = os.path.join(STRATEGIES, "starling", "main", "scanners", "scoring.py")


def test_scoring_is_byte_identical_to_phalanx():
    with open(SRC, "rb") as a, open(DST, "rb") as b:
        assert a.read() == b.read(), "starling/main/scanners/scoring.py drifted from phalanx"
