"""Guard: scorpion's marginPct must be a PERCENT in (0,100], never a v2 fraction.
...
since 0.25 still satisfies the (0,100] bound). marginPct is a pure pass-through
config value here: read in scan.py (inputs.marginPct, default 25) and emitted
verbatim at the candidate top level; scoring.score_market never reads it. So this
is a config-level invariant, asserted directly against the wire-bound value.
"""
