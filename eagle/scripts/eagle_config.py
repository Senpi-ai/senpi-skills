"""EAGLE Strategy — Shared config, MCP helpers, state I/O."""
...
SKILL_DIR = Path(WORKSPACE) / "skills" / "eagle-strategy"
CONFIG_PATH = SKILL_DIR / "config" / "eagle-config.json"
...
def get_wallet_and_strategy():
    wallet = os.environ.get("EAGLE_WALLET", "")
    strategy_id = os.environ.get("EAGLE_STRATEGY_ID", "")
