...
|------|-----|----------------|
| Tier 1 (fast/cheap) | Scanners, OI tracker, DSL math | model configured in OpenClaw |
| Tier 2 (capable) | Goal engine, risk guardian, exit evaluation | model configured in OpenClaw |
